...
一个仍在早期的轻量 AI 协作 skill 实验。

它不是一个成型产品，也不是一套已经定型的工程方法论。现在的它更像一个起点：我们希望用一个可复用、可迁移、足够克制的 skill，帮助小项目、练手项目、初创团队、黑客松作品和早期产品更快建立 AI 协作的基本秩序。
...
- **真实失败案例库**：AI 读错上下文、误报完成、复盘没有行动、文档规则漂移、协作者的 agent 互相误解，这些都不只是事故，也可以变成可复用的学习材料。
